...
class Benchmark {
    ...
    public static void main(String[] args) {
        ...
        Matrix Ones = new Matrix(3000, 3000, 1);
        Matrix C2 = new Matrix(3000, 3000);
        Matrix.finish();
        resetTimer();
        C2 = MatrixMath.pow(-Math.E, A, C2); // C = e^(-A)
        C2.plusEquals(Ones); // C = 1 + C = 1 + e^A;
        C2.leftDivideEquals(1); // C = 1/C = 1/(1 + e^A)
        Matrix.finish();
